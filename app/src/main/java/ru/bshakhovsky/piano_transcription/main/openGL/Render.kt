...
class Render(
    ...
    override fun onSurfaceCreated(glUnused: GL10?, config: EGLConfig?) {
        ...
        GLES31 or GLES32 would cause crash right here:

        java.lang.NoClassDefFoundError: Failed resolution of: Landroid/opengl/GLES32;
        Caused by: java.lang.ClassNotFoundException: Didn't find class "android.opengl.GLES32"
        on path: DexPathList[[zip file "/data/app/ru.BShakhovsky.Piano_Transcription-1/base.apk"],
