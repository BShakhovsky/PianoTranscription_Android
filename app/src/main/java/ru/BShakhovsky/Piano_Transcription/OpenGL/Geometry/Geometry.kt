...
class Geometry {
    ...
    companion object {
        ...
        const val blackLen: Float = 85 + cotThick
    ...
    private val filletSide = blackWid / 3
    private val filletFront = filletSide * 3
    ...
    @Suppress("Reformat")
    val cotton: Primitive = Primitive(
        floatArrayOf(
